...
import * as martialSkills from './martial/index.js'
import * as tradeSkills from './trade/index.js';
import * as weaponSkills from './weapon/index.js';
export const allSkills = [...Object.values(stealthSkills), ...Object.values(martialSkills), ...Object.values(racialSkills), ...Object.values(scholarlySkills), ...Object.values(tradeSkills), ...Object.values(weaponSkills)].flatMap((skill) => skill);
