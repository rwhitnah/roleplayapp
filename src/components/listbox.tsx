...
export function Listbox<T>({
  ...
  'aria-label'?: string
  children?: any
} & Omit<Headless.ListboxProps, 'as' | 'multiple'>) {
  return (
...
>) {
  ...
  return (
    //@ts-ignore
    <Headless.ListboxOption className={'any'} {...props}>
...
export function ListboxLabel({ className, ...props }: any) {
  return <span {...props} className={clsx(className, 'ml-2.5 truncate first:ml-0 sm:ml-2 sm:first:ml-0')} />
}

export function ListboxDescription({ className, children, ...props }: any) {
  return (
    <span
      {...props}
      className={clsx(
