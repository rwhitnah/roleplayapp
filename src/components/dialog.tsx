...
export function Dialog({
  ...
  children,
  ...props
}: { size?: keyof typeof sizes; className?: string; children: any } & Omit<
  Headless.DialogProps,
  'as' | 'className'
>) {
  return (
    <Headless.Dialog {...props} onClose={()=> {}}>
...
export function DialogBody({ className, ...props }: any) {
  return <div {...props} className={clsx(className, 'mt-6')} />
}

export function DialogActions({ className, ...props }: any) {
  return (
    <div
      {...props}
      className={clsx(
