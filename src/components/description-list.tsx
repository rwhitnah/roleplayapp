...
export function DescriptionList({ className, ...props }: any) {
  return (
    <dl
      {...props}
      className={clsx(
...
export function DescriptionTerm({ className, ...props }: any) {
  return (
    <dt
      {...props}
      className={clsx(
...
export function DescriptionDetails({ className, ...props }: any) {
  return (
    <dd
      {...props}
      className={clsx(
